...
if(location.hostname.includes('map.baidu.com')){  
    window.onload = ()=>{ 
        setTimeout(()=>{  
            ...
            var allTypeObj = {
                all: [],
                passed: ["大中华汇展阁","丽湾国际公寓","罗湖金岸","汇商名苑","同泰时代广场","立新花园(人民北路)"],
                hasNotLook: [],
                willLook: ['笋岗大厦', '同乐大厦', '朗钜·御风庭', '好年华东门金座', '丰湖花园','阳光绿地家园','大地花园','翡翠星光园','东方盛世花园','居欢颜·美杜兰华庭','丽廷豪苑',"宝龙花园", "佳兆业新都汇", "东方都会", "丹枫雅苑", "大世纪水山缘", "云景豪园", "鸿翠苑", "泽润华庭", "鸿景豪苑", "信和爱琴居", "龙园山庄", "茂业城", "德兴城", "又一村花园", "丹枫白露城-东1号", "红树家邻", "安徽大厦创展中心", "龙珠花园", "彩福大厦"],
