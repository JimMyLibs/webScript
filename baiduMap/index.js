        ...
        setTimeout(()=>{  
            const allTypeColors = {
                ...
                willLook: {
                    ...
                    communitis: [ '阳光绿地家园', '佳兆业新都汇','东方都会','龙景花园','曦龙山庄','东方凤雅台','雅乐居','兴达华府'],
                },
                looked:  {
                    label: '已看',
                    color: '#666666',
                    ...
                    communitis: ['旺业豪苑', '南塘物业小区','城市天地广场', '云景豪园', '双城世纪大厦','阳光新干线家园','长丰苑','笋岗大厦', 
                                ...
                                '东海大厦', '宏丰大厦','怡康家园', '东方盛世花园', '信义假日名城-溢芳园', '国展苑', '大地花园', '信和爱琴居','深圳桐林公寓',
                                '红树家邻','韵动家园','祥云天都世纪-A栋'],
                },
                oneStar: {
                    label: '一星',
                    ...
                    communitis: ['国际名园','广兴源圣拿威湾美花园','名仕阁','好年华东门金座', '国展苑', '祥福雅居'],
                },
                twoStar: {
                    label: '二星',
                    color: '#4CAF50',
            ...
            Array.from(jimMark).map(item=>{
                allTypes.map(type=>{
                    ...
                    }else if(item.innerText.includes('幼儿园')){
