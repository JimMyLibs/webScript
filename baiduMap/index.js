        ...
        setTimeout(()=>{  
            const allTypeColors = {
                ...
                passed: {
                    ...
                    communitis: ['大中华汇展阁','丽湾国际公寓','罗湖金岸','汇商名苑','同泰时代广场','南塘物业小区', '龙园山庄'],
                },
                hasNotLook: {
                    label: '未看',
                    color: '#607D8B',
                ...
                willLook: {
                    ...
                    communitis: [ '朗钜·御风庭', '丰湖花园','阳光绿地家园','大地花园','翡翠星光园','东方盛世花园','居欢颜·美杜兰华庭','丽廷豪苑','宝龙花园', '佳兆业新都汇', '东方都会', '丹枫雅苑', '大世纪水山缘', '鸿翠苑', '泽润华庭', '鸿景豪苑', '信和爱琴居', '茂业城', '德兴城', '又一村花园', '丹枫白露城-东1号', '红树家邻', '安徽大厦创展中心', '彩福大厦'],
                },
                looked:  {
                    label: '已看',
                    color: '#666666',
                    sum: { '名称' : "已看", '总数' : 0,  '占比': 0 , '已标记': 0, '未标记': [] },// 已经看过的：手动录入
                    communitis: ['旺业豪苑', '南塘物业小区','城市天地广场', '云景豪园', '好年华东门金座', '双城世纪大厦','阳光新干线家园','长丰苑','笋岗大厦', '同乐大厦','银座金钻', '国际名园', '庐山花园','凯旋TRC', '汇泰大厦', '怡都大厦', '大中华汇展阁', '港岛银座', '星桂园-C座', '名仕阁', '好年华东门金座', '立新花园(人民北路)', '碧海富通城-三期', '碧海富通城-四期', '广兴源圣拿威湾美花园', '祥福雅居', '庐江春天公寓', '荔馨村', '桃苑公寓', '澎柏·白金假日公寓', '大都汇大厦', '龙珠花园', '国际市长交流中心', '友谊大厦', '南洋大厦', '东海大厦', '宏丰大厦'],
                },
                oneStar: {
                    label: '一星',
                    color: '#8BC34A',
                    sum: { '名称' : "一星", '总数' : 0,  '占比': 0 , '已标记': 0, '未标记': [] },
                    communitis: ['国际名园','港岛银座','广兴源圣拿威湾美花园','名仕阁','城市天地广场','好年华东门金座'],
                },
                twoStar: {
                    label: '二星',
                    color: '#4CAF50',
